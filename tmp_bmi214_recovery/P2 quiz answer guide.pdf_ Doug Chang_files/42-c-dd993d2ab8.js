...
u.attr({title:r,"aria-label":r})}}m("pse")
...
o.addEventListener("unstarted",(function(){m("pse")}),false)}})})(mejs.$)},C7He:function(e,t){(function(e){"use strict"
...
m.height(a-o)
m.css("top",i.top+o)}else{var n=u.width(),s=n*e
c.css("left",Math.round(i.left+s-c.width()/2))
m.width(Math.round(s))}},f=function(e){var t=null,i=u.offset()
...
return t.firstChild.href},getScriptPath:function(e){var t,i,a,o,n,s,r=0,l="",d="",u=document.getElementsByTagName("script"),m=u.length,c=e.length
for(;r<m;r++){o=u[r].src
i=o.lastIndexOf("/")
...
var a=t.timeFormat,o=a[0],n=a[1]==a[0],s=n?2:1,r=":",l=Math.floor(e/3600)%24,d=Math.floor(e/60)%60,u=Math.floor(e%60),m=Math.floor((e%1*i).toFixed(3)),c=[[m,"f"],[u,"s"],[d,"m"],[l,"h"]]
a.length<s&&(r=a[s])
var p=false
...
a.HtmlMediaElementShim={create:function(e,t){var i,o,n={},s="string"==typeof e?document.getElementById(e):e,r=s.tagName.toLowerCase(),l="audio"===r||"video"===r,d=l?s.getAttribute("src"):s.getAttribute("href"),u=s.getAttribute("poster"),m=s.getAttribute("autoplay"),c=s.getAttribute("preload"),p=s.getAttribute("controls")
...
s.addEventListener("click",(function(){s.play()}),false)}return this.updateNative(i,n,m,c)}if(""!==i.method)return this.createPlugin(i,n,u,m,c,p)
this.createErrorMessage(i,n,u)
return this},determinePlayback:function(e,t,i,o,n){var s,r,l,d,u,m,c,p,f,h,g,_=[],b={method:"",url:"",htmlMediaElement:e,isVideo:"audio"!==e.tagName.toLowerCase(),scheme:""}
...
_.push({type:m,url:n})}else for(s=0;s<e.childNodes.length;s++){u=e.childNodes[s]
...
if("auto_plugin"!==t.mode)return b}}if("auto"===t.mode||"auto_plugin"===t.mode||"shim"===t.mode)for(s=0;s<_.length;s++){m=_[s].type
for(r=0;r<t.plugins.length;r++){c=t.plugins[r]
p=a.plugins[c]
...
t.error(o)},createPlugin:function(e,t,i,o,n,s){var r,l,d,u=e.htmlMediaElement,m=1,c=1,p="me_"+e.method+"_"+a.meIndex++,f=new a.PluginMediaElement(p,e.method,e.url),h=document.createElement("div")
f.tagName=u.tagName
...
k&&(j=k[1])}youtubeSettings={container:h,containerId:h.id,pluginMediaElement:f,pluginId:p,videoId:j,height:c,width:m,scheme:e.scheme,playerVars:t.youtubePlayerVars}
...
var s
if("native"==n.media.pluginType){var r=null,l=null,d=null,u=null,m=null
var c=[]
var p=false
...
var m=function(e){var i,a=n.total.offset(),r=n.total.width(),l=0,d=0,u=0
...
let s,r,l=this,d=l.options.tracksAriaLive?'role="log" aria-live="assertive" aria-atomic="false"':"",u=l.options.tracksText?l.options.tracksText:n.t("Captions/Subtitles")
...
"subtitles"!==r&&"captions"!==r||m++}let c="none"
...
Promise.all([i.e(5),i.e(579)]).then(i.bind(null,"z8T/")).then(e=>{let i=e.default
...
t.hasChapters=true
break}},drawChapters(t){let i,a,o=this,n=0,s=0
o.chapters.empty()
...
mejs.TrackFormatParser={webvtt:{pattern_timecode:/^((?:[0-9]{1,2}:)?[0-9]{2}:[0-9]{2}([,.][0-9]{1,3})?) --\> ((?:[0-9]{1,2}:)?[0-9]{2}:[0-9]{2}([,.][0-9]{3})?)(.*)$/,parse(t){let i,a,o,n=0,s=mejs.TrackFormatParser.split2(t,/\r?\n/),r={text:[],times:[]}
...
r.text.push(a)
r.times.push({identifier:o,start:0===mejs.Utility.convertSMPTEtoSeconds(i[1])?.2:mejs.Utility.convertSMPTEtoSeconds(i[1]),stop:mejs.Utility.convertSMPTEtoSeconds(i[3]),settings:i[5]})}o=""}return r}},dfxp:{parse(t){t=e(t).filter("tt")
let i,a,o=0,n=t.children("div").eq(0),s=n.find("p"),r=t.find("#"+n.attr("style")),l={text:[],times:[]}
if(r.length){const e=r.removeAttr("id").get(0).attributes
if(e.length){i={}
for(o=0;o<e.length;o++)i[e[o].name.split(":")[1]]=e[o].value}}for(o=0;o<s.length;o++){var d
const t={start:null,stop:null,style:null}
s.eq(o).attr("begin")&&(t.start=mejs.Utility.convertSMPTEtoSeconds(s.eq(o).attr("begin")))
!t.start&&s.eq(o-1).attr("end")&&(t.start=mejs.Utility.convertSMPTEtoSeconds(s.eq(o-1).attr("end")))
s.eq(o).attr("end")&&(t.stop=mejs.Utility.convertSMPTEtoSeconds(s.eq(o).attr("end")))
!t.stop&&s.eq(o+1).attr("begin")&&(t.stop=mejs.Utility.convertSMPTEtoSeconds(s.eq(o+1).attr("begin")))
if(i){d=""
...
const j=550
const k=448
c.a.extend(u["a"].MediaElementDefaults,{pluginPath:"/images/mediaelement/",defaultVideoWidth:j,defaultVideoHeight:k})
u["a"].MepDefaults.success=function(e,t){i.e(594).then(i.bind(null,"ozaW")).then(t=>{let i=t.default
...
n.mode="auto_plugin"
n.isVideo=false
n.videoHeight=a=30}return y.getElement(s,r,o,a)}const S={create(e,t,i,a){c()("#media_recorder_container").removeAttr("id")
...
const o=function(e,i){const a=Math.min(i.closest("div,p,table").width()||j,j)
const o=Math.round(a/336*240)
return x(e).done(s=>{if(s.sources.length){const n={can_add_captions:s.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e,menuTimeoutMouseLeave:50,success(e){i.focus()
e.play()},keyActions:[{keys:r.a.values(_.keyCodes),action(e,t,i,a){if(e.isVideo){e.showControls()
e.startControlsTimer()}const o=new _(u["a"],e,t,a)
o.dispatch()}}]}
const l=T({sourcesAndTracks:s,mediaPlayerOptions:n,mediaType:t,height:o,width:a})
l.appendTo(i.html(""))
...
return c.a.ajaxJSON(e,"GET",{},s,t)}return o(e,a)},show(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"video"
...
if("video"===t){o=426
s=j}else{o=180
s=400}const r=c()('<div style="overflow: hidden; padding: 0;" />')
...
return r.disableWhileLoading(x(e).done(i=>{if(i.sources.length){const n={can_add_captions:i.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e}
const l=T({sourcesAndTracks:i,mediaPlayerOptions:n,mediaType:t,height:o,width:s})
l.appendTo(r.html(""))
...
let _=false
let b=null
m.a.mediaComment.init=function(e,t){Promise.all([i.e(5),i.e(23),i.e(78),i.e(346)]).then((()=>{const a=i("ufgb")
b=b||new Date
e=e||"any"
t=t||{}
let o=m.a.trim(m()("#identity .user_name").text()||"")
o&&(o=o+": "+(new Date).toString("ddd MMM d, yyyy"))
const s=t.defaultTitle||o||n.t("titles.media_contribution","Media Contribution")
const r=function(){let i,o
if(INST.kalturaSettings.js_uploader){i=f.getKs()
o=f.getUid()}else{i=d.data("ks")
o=d.data("uid")||"ANONYMOUS"}m()("#video_record_title,#audio_record_title").val(s)
...
k&&k[0]&&k[0].getMicophoneActivityLevel&&k.parent().length?t=k[0].getMicophoneActivityLevel():k=m()("#video_record")
...
const n=o();("Chrome"===n.name&&Number(n.version)>=68||"Firefox"===n.name&&Number(n.version)>=61)&&Promise.all([i.e(1),i.e(2),i.e(3),i.e(4),i.e(7),i.e(8),i.e(9),i.e(10),i.e(11),i.e(12),i.e(17),i.e(21),i.e(89),i.e(99),i.e(560)]).then(i.bind(null,"kImW")).then(e=>{let t=e.default
let i
...
var o=e.height,n=e.width,s=i,r=o*i/n,l=n*a/o,d=a,u=!(l>i),m=u?Math.floor(s):Math.floor(l),c=u?Math.floor(r):Math.floor(d)
...
//# sourceMappingURL=42-c-dd993d2ab8.js.map