...
i=o()(e.message).dialog(o.a.extend({},{modal:true,close:r,buttons:[{text:n.t("#buttons.cancel","Cancel"),click(){o()(this).dialog("close")}},{text:n.t("#buttons.delete","Delete"),class:"btn-primary",click(){s=true
...
//# sourceMappingURL=19-c-8d66b1ffdd.js.map