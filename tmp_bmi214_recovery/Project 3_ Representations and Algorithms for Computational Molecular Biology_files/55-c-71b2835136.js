(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[55],{"4bdt":function(e,c,o){"use strict"
var t=o("pQTu")
var l=o("m0r6")
...
var i=o("5Ky4")
o("Z+Ib")
var d=function(e,c){for(var o in c)k.call(c,o)&&(e[o]=c[o])
function t(){this.constructor=e}t.prototype=c.prototype
e.prototype=new t
e.__super__=c.prototype
return e},k={}.hasOwnProperty
var p=function(e){d(c,e)
...
c.prototype.hover=function(e){var c
c=e.type
if(this.disabled)return
if("mouseenter"===c)return this.isLocked()?this.renderWillUnlock():this.renderWillLock()
if("mouseleave"===c)return this.isLocked()?this.renderLocked():this.renderUnlocked()}
...
c.prototype.setLockState=function(e){return _.a.ajaxJSON("/api/v1/courses/"+this.course_id+"/blueprint_templates/default/restrict_item","PUT",{content_type:this.content_type,content_id:this.content_id,restricted:e},(c=this,function(o){c.model.set("restricted_by_master_course",e)
c.trigger(e?"lock":"unlock")
c.render()
c.setFocusToElement()
c.closeTooltip()
return null}),function(e){return function(c){return e.setFocusToElement()}}(this))
var c}
...
c.prototype.closeTooltip=function(){return _()(".ui-tooltip").remove()}
...
this.cacheEls()
return this.isLocked()?this.renderLocked():this.renderUnlocked()}
c.prototype.renderLocked=function(){return this.renderState({hint:r.t("Locked"),label:this.lockedText,buttonClass:this.lockedClass+" "+this.disabledClass,iconClass:"icon-blueprint-lock"})}
c.prototype.renderWillUnlock=function(){return this.renderState({hint:r.t("Unlock"),label:this.lockedText,buttonClass:this.unlockedClass+" "+this.disabledClass,iconClass:"icon-blueprint"})}
c.prototype.renderUnlocking=function(){return this.renderState({hint:r.t("Unlocking..."),buttonClass:this.lockedClass+" "+this.disabledClass,iconClass:"icon-blueprint-lock"})}
c.prototype.renderUnlocked=function(){return this.renderState({hint:r.t("Unlocked"),label:this.unlockedText,buttonClass:this.unlockedClass+" "+this.disabledClass,iconClass:"icon-blueprint"})}
c.prototype.renderWillLock=function(){return this.renderState({hint:r.t("Lock"),label:this.unlockedText,buttonClass:this.lockedClass+" "+this.disabledClass,iconClass:"icon-blueprint-lock"})}
c.prototype.renderLocking=function(){return this.renderState({hint:r.t("Locking..."),buttonClass:this.unlockedClass+" "+this.disabledClass,iconClass:"icon-blueprint"})}
...
return c}(s.a.View)
var u=function(e,c){for(var o in c)b.call(c,o)&&(e[o]=c[o])
function t(){this.constructor=e}t.prototype=c.prototype
e.prototype=new t
e.__super__=c.prototype
return e},b={}.hasOwnProperty
c["a"]=function(e){u(c,e)
function c(){return c.__super__.constructor.apply(this,arguments)}c.prototype.lockClass="lock-icon-lock"
c.prototype.lockedClass="lock-icon-locked"
c.prototype.unlockClass="lock-icon-unlock"
c.prototype.tagName="span"
c.prototype.className="lock-icon"
c.optionProperty("lockText")
c.optionProperty("unlockText")
c.prototype.initialize=function(){c.__super__.initialize.apply(this,arguments)
return this.events=Object.assign({},p.prototype.events,this.events)}
c.prototype.events={keyclick:"click"}
return c}(p)},MdYG:function(e,c,o){"use strict"
var t=o("pQTu")
var l=o("m0r6")
...
const n={points:{label:r.t("points"),key:"points"},percent:{label:r.t("percent"),key:"percent"},letter_grade:{label:r.t("letter grade"),key:"letter_grade"},gpa_scale:{label:r.t("GPA scale"),key:"gpa_scale"},other:{label:r.t("other"),key:"other"}}
var _=n
...
var a=t["default"].scoped("cyoe_assignment_sidebar_score")
var s=o("HbFp")
o.d(c,"b",(function(){return u}))
o.d(c,"a",(function(){return m}))
const i=e=>{const c=s["a"].parse(e)
return!isNaN(c)&&isFinite(c)}
const d=e=>!!e&&!!e.grading_scheme
const k=e=>{const c=e?e.grading_type:_.percent.key
if((c===_.letter_grade.key||c===_.gpa_scale.key)&&!d(e))return _.percent.key
return c}
const p=(e,c)=>{const o=k(c)
return o===_.points.key?f(e,c):o===_.letter_grade.key||o===_.gpa_scale.key?g(e,c):h(e)}
const u=(e,c,o)=>{e||(e=o?"1":"0")
return b(p(e,c),c)}
const b=(e,c)=>{const o=k(c)
return o===_.points.key?a.t("%{score} pts",{score:a.n(e,{precision:2,strip_insignificant_zeros:true})}):o===_.letter_grade.key||o===_.gpa_scale.key?e:a.n(e,{precision:2,percentage:true,strip_insignificant_zeros:true})}
const f=(e,c)=>{if(!i(e))return e
if(0===e)return"0"
const o=s["a"].parse(e)
const t=Number(c.points_possible)||100
return parseFloat((o*t).toFixed(2))}
const g=(e,c)=>{if(""===e)return""
const o=s["a"].parse(e)
const t={letter:null,score:-Infinity}
for(const e in c.grading_scheme){const l=s["a"].parse(c.grading_scheme[e])
if(l<=o&&l>t.score||0===l&&l>o){t.score=l
t.letter=e}}return t.letter?t.letter:o}
const h=e=>{if(!i(e))return e
return Math.floor(100*e)}
const m=(e,c)=>{if("string"===typeof e&&c.grading_type!==_.letter_grade.key&&c.grading_type!==_.gpa_scale.key){const o=s["a"].parse(e.replace(/%$/,""))
if(!isNaN(o))return b(o,c)}return e}},veHt:function(e,c,o){"use strict"
var t=o("pQTu")
var l=o("m0r6")
...
var n=o("MdYG")
const _=()=>ENV.CONDITIONAL_RELEASE_SERVICE_ENABLED||false
const a=()=>{const e=ENV.CONDITIONAL_RELEASE_ENV&&ENV.CONDITIONAL_RELEASE_ENV.active_rules||[]
return{triggerAssignments:e.reduce((e,c)=>{e[c.trigger_assignment]=c
return e},{}),releasedAssignments:e.reduce((e,c)=>{c.scoring_ranges.forEach(o=>{o.assignment_sets.forEach(t=>{t.assignments.forEach(t=>{const l=t.assignment_id
e[l]=e[l]||[]
e[l].push({assignment_id:c.trigger_assignment,assignment:c.trigger_assignment_model,upper_bound:o.upper_bound,lower_bound:o.lower_bound})})})})
return e},{})}}
let s=a()
const i=e=>s.triggerAssignments.hasOwnProperty(e)
const d=e=>s.releasedAssignments.hasOwnProperty(e)
const k=e=>{const c=s.releasedAssignments[e]||[]
if(c.length>1)return r.t("Multiple")
if(c.length>0){const e=c[0]
...
c["a"]={isEnabled:_,reloadEnv(){s=a()},getItemData(e){let c=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
e=e&&e.toString()
return _()?{isCyoeAble:e&&c,isTrigger:e&&c&&i(e),isReleased:d(e),releasedLabel:k(e)}:{}}}}}])

//# sourceMappingURL=55-c-71b2835136.js.map